  ...
  return (
    <motion.div variants={item}>
      <Link
        ...
        className="group block bg-card rounded-xl overflow-hidden border border-border shadow-sm hover:shadow-xl transition-all duration-300 hover:border-accent/50 hover:-translate-y-1"
      >
