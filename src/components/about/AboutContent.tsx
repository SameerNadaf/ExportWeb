      ...
      <section className="py-20 container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
            className="h-[400px] relative bg-muted rounded-2xl overflow-hidden shadow-lg"
          >
            <Image
          ...
          >
            {[
              ...
              <motion.div
                key={value.title}
                variants={fadeInUp}
                className="bg-background p-8 rounded-xl shadow-sm border border-border text-center hover:shadow-md transition-shadow"
              >
