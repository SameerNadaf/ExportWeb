            ...
            <div className="flex flex-wrap gap-4">
              {data?.whatsapp && (
                <a
                  ...
                  className="p-3 bg-green-100 text-green-600 rounded-full hover:bg-green-600 hover:text-white transition-colors"
                  title="WhatsApp"
                >
                  <svg
                    className="w-5 h-5"
              ...
              {data?.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 bg-pink-100 text-pink-600 rounded-full hover:bg-pink-600 hover:text-white transition-colors"
                  title="Instagram"
                >
                  <svg
                    className="w-5 h-5"
